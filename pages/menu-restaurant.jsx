      ...
      <section className="section kf-started-inner">
        ...
        <div className="container">
          <h1
            ...
            data-animate="active"
          >
            Moo and More Dairy farm Services
          </h1>
        </div>
      </section>
      {/* Section Menu-2 */}
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
              <div className="kf-menu-items-2">
                ...
                >
                  ...
                  <div className="desc">
                    <h5 className="name">Yorguart Making</h5>
                    <div className="subname">Sed ut perspiciatis unde</div>
                    <div className="price">
                      <span>$199</span>
                    </div>
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
              ...
              <div className="kf-menu-items-2">
                ...
                >
                  ...
                  <div className="desc">
                    <h5 className="name">Breeding Bulls</h5>
                    <div className="subname">Sed ut perspiciatis unde</div>
                    <div className="price">
                      <span>$4.9</span>
                    </div>
                ...
                >
                  ...
                  <div className="desc">
                    <h5 className="name">Milking Machine</h5>
                    <div className="subname">Sed ut perspiciatis unde</div>
                    <div className="price">
                      <span>$79.0</span>
                    </div>
                ...
                >
                  ...
                  <div className="desc">
                    <h5 className="name">cheese Making</h5>
                    <div className="subname">Sed ut perspiciatis unde</div>
                    <div className="price">
                      <span>$99.9</span>
                    </div>
